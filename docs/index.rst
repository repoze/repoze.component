...
:mod:`repoze.plugin` is a package that software developers can use to
...
The :mod:`repoze.plugin` registry can help provide a highly general
application configuration system.  If logic in your application
indirects lookups through a :mod:`repoze.plugin` "component registry",
